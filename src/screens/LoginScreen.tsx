...
export default function LoginScreen() {
  ...
  // Estados do modal de recuperar senha
  ...
  async function handleLogin() {
    ...
    // Se não tiver erro, o AuthContext vai mudar a sessão
    // e o App.tsx vai redirecionar automaticamente para Home
  }
        ...
        >
          ...
          <View style={styles.card}>
            ...
            <View
              style={[
                styles.inputWrapper,
                erroLogin ? styles.inputError : null,
              ]}
            >
            ...
            {/* Botão Google (visual apenas por enquanto) */}
            <TouchableOpacity
